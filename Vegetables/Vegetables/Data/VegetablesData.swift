...
let vegetablesData: [Vegetable] = [
    Vegetable(
        ...
        image: "茄子",
        gradientColors: [Color("Color-茄子-Light"), Color("Color-茄子-Dark")],
        description: "茄（学名：Solanum melongena L.）茄科，茄属植物。茄直立分枝草本至亚灌木，高可达1米，小枝，叶柄及花梗均被6-8-（10）分枝，平贴或具短柄的星状绒毛，小枝多为紫色（野生的往往有皮刺），渐老则毛被逐渐脱落。叶大，卵形至长圆状卵形，叶柄长约2-4.5厘米（野生的具皮刺）。能孕花单生，花柄长约1-1.8厘米，毛被较密。果的形状大小变异极大。果的形状有长或圆，颜色有白、红、紫等。",
        classification: ["被子植物门","双子叶植物纲","合瓣花亚纲","管状花目","茄科","茄族","茄属","茄","原产亚洲热带，中国各省均有栽培"]),
    
    Vegetable(
        title: "冬瓜",
        headline: "冬瓜果实除作蔬菜外，也可浸渍为各种糖果；果皮和种子药用，有消炎、利尿、消肿的功效",
        image: "冬瓜",
        gradientColors: [Color("Color-冬瓜-Light"), Color("Color-冬瓜-Dark")],
        description: "冬瓜（学名：Benincasa hispida (Thunb.) Cogn.），葫芦科冬瓜属一年生蔓生或架生草本植物，茎被黄褐色硬毛及长柔毛，有棱沟，叶柄粗壮，被粗硬毛和长柔毛，雌雄同株，花单生，果实长圆柱状或近球状，大型，有硬毛和白霜，种子卵形。",
        classification: ["被子植物门","双子叶植物纲","五桠果亚纲","堇菜目","葫芦科","冬瓜族","冬瓜属","冬瓜","亚洲其他热带、亚热带地区"]),
  
    Vegetable(
        title: "胡萝卜",
        headline: "胡萝卜素是维生素A的主要来源，而维生素A可以促进生长，防止细菌感染，以及具有保护表皮组织，保护呼吸道、消化道、泌尿系统等上皮细胞组织的功能与作用；",
        image: "胡萝卜",
        gradientColors: [Color("Color-胡萝卜-Light"), Color("Color-胡萝卜-Dark")],
        ...
        classification: ["被子植物门","双子叶植物纲","原始花被亚纲","伞形目","伞形科","胡萝卜族","胡萝卜属","胡萝卜","原产亚洲西部，阿富汗,10世纪时经伊朗传入欧洲大陆，15世纪英国已有栽培，16世纪传入美国。12世纪经伊朗传入中国，日本在16世纪从中国引入。"]),
  
    Vegetable(
        title: "黄瓜",
        headline: "中国各地普遍栽培，且许多地区均有温室或塑料大棚栽培；现广泛种植于温带和热带地区。黄瓜为中国各地夏季主要菜蔬之一。茎藤药用，能消炎、祛痰、镇痉。",
        image: "黄瓜",
        gradientColors: [Color("Color-黄瓜-Light"), Color("Color-黄瓜-Dark")],
        ...
        classification: ["被子植物门","双子叶植物纲","合瓣花亚纲","葫芦目","葫芦科","无","黄瓜属","黄瓜","世界各地"]),
 
    Vegetable(
        title: "西蓝花",
        headline: "西蓝花，俗称青花菜。原产意大利，是常见蔬菜。通称绿花菜，也被称为西兰花。二年生草本植物，是甘蓝的一种变种。叶子大，主茎顶端形成肥大的花球，绿色或紫绿色，表面的小花蕾不密集在一起，侧枝的顶端各生小花球。",
        image: "西蓝花",
        gradientColors: [Color("Color-西蓝花-Light"), Color("Color-西蓝花-Dark")],
        description: "西兰花是一种营养价值非常高的蔬菜，几乎包含人体所需的各种营养元素，含有蛋白质、糖、脂肪、矿物质、维生素和胡萝卜素等，被誉为“蔬菜皇冠”。西兰花中矿物质成分比其他蔬菜更全面，钙、磷、铁、钾、锌、锰等含量很丰富，比同属于十字花科的白菜花高出很多。西兰花不仅味道鲜美，其药用价值近年来也被医学界所发现。研究表明，西兰花含硫萝卜素，可刺激身体产生抗癌蛋白酵素。经常食用，有助排除体内有害的自由基。西兰花含有丰富的抗坏血酸，能增强肝脏的解毒能力，提高肌体免疫力。西兰花被誉为“防癌新秀”，能有效对抗乳癌和大肠癌，健康的人经常食用西兰花也能起到预防癌症的作用。西兰花对高血压、心脏病有调节和预防的功用。西兰花是糖尿病患者的福音食品，富含的高纤维能有效降低肠胃对葡萄糖的吸收，进而降低血糖，有效控制糖尿病的病情。常吃西兰花还可以抗衰老，防止皮肤干燥，是一种很好的美容佳品；医学界还认为西兰花对大脑、视力都有很好的作用，是营养丰富的综合保健蔬菜。",
        classification: ["被子植物门","双子叶植物纲","五桠果亚纲","白花菜目","十字花科","无","芸苔属","西蓝花","意大利"]),
