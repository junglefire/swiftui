...
struct NewRestaurantView: View {
    ...
    @State
    private var restaurantImage = UIImage(named: "newphoto")!
    
    @State
    private var showPhotoOptions = false
...
//        FormTextField(label: "Name", placeholder: "input", value: .constant(""))
//    }
//}
